...
function PortalProfileUpdatePassword() {
  const { t: __ } = useTranslation(["static-text"]);
  return /* @__PURE__ */ jsx(
    PortalLayout,
    {
      pageTittle: __("Change Password"),
      activePage: "profile",
      tittle: __("Change Password"),
      ...
      children: /* @__PURE__ */ jsx(Div, { className: "max-w-7xl mx-auto mt-8 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs(Div, { className: "flex flex-col md:flex-row gap-8", children: [
        ...
        /* @__PURE__ */ jsx(Div, { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
          /* @__PURE__ */ jsxs(Div, { className: "flex items-center gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-gray-900 dark:text-white", children: __("Change Password") })
          ] }),
          /* @__PURE__ */ jsxs("form", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs(Div, { children: [
              /* @__PURE__ */ jsx(Label, { children: __("Current Password") }),
              /* @__PURE__ */ jsx(
                Input,
                {
                  id: "current_password",
            ...
            /* @__PURE__ */ jsxs(Div, { children: [
              /* @__PURE__ */ jsx(Label, { children: __("New Password") }),
              /* @__PURE__ */ jsx(
                Input,
                {
                  id: "new_password",
            ...
            /* @__PURE__ */ jsxs(Div, { children: [
              /* @__PURE__ */ jsx(Label, { children: __("Confirm New Password") }),
              /* @__PURE__ */ jsx(
                Input,
                {
...
export {
  PortalProfileUpdatePassword as default
};
