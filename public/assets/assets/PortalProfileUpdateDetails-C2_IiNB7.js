...
function PortalProfileUpdateDetails() {
  const { t: __ } = useTranslation(["static-text"]);
  return /* @__PURE__ */ jsx(
    PortalLayout,
    {
      pageTittle: __("Update Profile Details"),
      activePage: "profile",
      tittle: __("Update Profile Details"),
      ...
      children: /* @__PURE__ */ jsx(Div, { className: "max-w-7xl mx-auto mt-8 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs(Div, { className: "flex flex-col md:flex-row gap-8", children: [
        ...
        /* @__PURE__ */ jsx(Div, { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
          /* @__PURE__ */ jsxs(Div, { className: "flex items-center gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-gray-900 dark:text-white", children: __("Edit Your Details") })
          ] }),
          /* @__PURE__ */ jsxs("form", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs(Div, { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ jsxs(Div, { children: [
                /* @__PURE__ */ jsx(Label, { children: __("First Name") }),
                /* @__PURE__ */ jsx(
                  Input,
                  {
                    id: "name",
              ...
              /* @__PURE__ */ jsxs(Div, { children: [
                /* @__PURE__ */ jsx(Label, { children: __("Surname") }),
                /* @__PURE__ */ jsx(
                  Input,
                  {
                    id: "surname",
            ...
            /* @__PURE__ */ jsxs(Div, { children: [
              /* @__PURE__ */ jsx(Label, { children: __("Email") }),
              /* @__PURE__ */ jsx(
                Input,
                {
                  id: "email",
...
export {
  PortalProfileUpdateDetails as default
};
