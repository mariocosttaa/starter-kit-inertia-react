export type ButtonType = 'default' | 'primary' | 'secondary' | 'success' | 'danger' | 'warning' | 'info' | 'light' | 'dark';
...
const getButtonClasses = (type: ButtonType, size: ButtonSize) => {
  const sizes = {
...
export default function Button({ children, className = '', classNameAdd = '', type = 'default', size = 'md', ...props }: ButtonProps) {
  return (
    <button
